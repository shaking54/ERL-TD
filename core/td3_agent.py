...
class Agent:
    def __init__(self, args: Parameters, env):
        ...
        for _ in range(args.pop_size):
            #self.pop.append(td3.GeneticAgent(args))
            genetic = td3.GeneticAgent(args)
        ...
        self.ounoise = td3.OUNoise(args.action_dim)
    ...
    def evaluate(self, agent: td3.GeneticAgent or td3.TD3, state_embedding_net, is_render=False, is_action_noise=False,
    ...
    def rl_to_evo(self, rl_agent: td3.TD3, evo_net: td3.GeneticAgent):
    ...
    def train_ddpg(self, evo_times,all_fitness, state_list_list,reward_list_list, policy_params_list_list,action_list_list):
        ...
        if len(self.replay_buffer.storage) >= 5000:#self.args.batch_size * 5:
            ...
            td3.hard_update(self.rl_agent.old_state_embedding, self.rl_agent.state_embedding)
            for gen in self.pop:
