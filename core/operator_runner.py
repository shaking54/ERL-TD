...
class OperatorRunner:
    ...
    def load_genetic_agent(self, source, model):
        ...
        agent = policy_gradient.GeneticAgent(self.args)
        ...
        for i, model1 in enumerate(models):
            for j, model2 in enumerate(models):
                if j > i:
                    ...
                    critic = policy_gradient.Critic(self.args)
                    ...
                    child1 = policy_gradient.GeneticAgent(self.args)
                    child2 = policy_gradient.GeneticAgent(self.args)
    ...
    def test_mutation(self):
        ...
        for i, model in enumerate(models):
            ...
            nchild = policy_gradient.GeneticAgent(self.args)
            ...
            dchild = policy_gradient.GeneticAgent(self.args)
